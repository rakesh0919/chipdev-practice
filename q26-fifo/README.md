Q26 — Multi-Bit FIFO Testbench
Verification exercise for ChipDev Q26.
The FIFO holds 2 entries of 8 bits. There is no read signal as dout shows the oldest entry immediately. I focused on testing the boundary conditions.
